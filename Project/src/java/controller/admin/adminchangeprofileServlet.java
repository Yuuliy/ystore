 ...
 */
@MultipartConfig
@WebServlet(name="adminchangeprofileServlet", urlPatterns={"/admin-changeprofile"})
public class adminchangeprofileServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet adminchangeprofileServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet adminchangeprofileServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        request.getRequestDispatcher("view/admin/change-profile.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        pd.changeProfile(a);
        response.sendRedirect("admin-changeprofile");
    }
