                ...
                <div class="content">
                    <div class="row">
                        <div class="col-md-6 offset-md-3">
                            <h4 class="page-title">Update Producer</h4>

                            <form action="update-producer" method="post">
                                <input type="text" name="producerid" value="${prod.producerID}">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Producer Name</label>
                                            <input type="text" class="form-control" name="name" value="${prod.producerName}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Country</label>
                                            <input name="country" type="text" class="form-control" value="${prod.country}">
                                        </div>
                                    </div>
                                </div>
