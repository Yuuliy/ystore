                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="login_form_inner">
                            ...
                            <form class="row login_form" action="changepass" method="post" id="contactForm" novalidate="novalidate">
                                <div class="col-md-12 form-group">
                                    <input onchange="oldPass()" type="password" class="form-control" id="oldpass" name="oldpass" placeholder="Old Password" id="oldpass"onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'">
                                    <h5 style="color: red" id="showErrorOld" hidden>Password incorrect</h5>
                                </div>
                                <div class="col-md-12 form-group">
                                    <input onchange="newPass()" type="password" class="form-control" id="newpass" name="newpass" placeholder="New Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'">
