        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <form action="update-product" method="post" id="contactForm" novalidate="novalidate" enctype="multipart/form-data">
                                <input type="text" name="productid" value="${product.productID}" hidden>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Product Name</label>
                                            <input class="form-control" type="text" name="proName" value="${product.productName}">
                                        </div>
                                    </div>                                    
                                </div><div class="row">                                    
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label>Amount</label>
                                            <input class="form-control" type="text" name="amount" value="${product.price}">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="insurance" value="${product.insurance}"/>                
                                        </div>
                                    </div>
                                ...
                                <div class="row">                                
                                    <div class="col-sm-6">
                                        ...
                                        <img style="max-width: 200px; min-width: 200px" id="output" src="${product.images.image1}"/>
