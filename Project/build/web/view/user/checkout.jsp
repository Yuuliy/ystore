<%-- 
    Document   : checkout
    Created on : Oct 28, 2022, 10:15:19 PM
    Author     : Dell
--%>
                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                ...
                                <div class="col-md-6 form-group p_star">
                                    ...
                                    <input type="text" class="form-control" id="first" name="firstName" value="${sessionScope.account.info.firstName}"/>

                                </div><br/>
                                <div class="col-md-6 form-group p_star">
                                    <span>Last Name</span></br>
                                    <input type="text" class="form-control" id="last" name="lastName" value="${sessionScope.account.info.lastName}"/>

                                </div>
                                <div class="col-md-6 form-group p_star">
                                    <span>Phone</span></br>
                                    <input type="text" class="form-control" id="number" name="Phone" value="${sessionScope.account.info.phone}"/>
                                ...
                                <div class="col-md-12 form-group p_star">
                                    ...
                                    <input type="text" class="form-control" id="country" name="deliaddress">
                                </div>
                                ...
                                <div class="order_box">
                                    ...
                                    <ul class="list">
                                        <li><a href="#">Product <span>Total</span></a></li>
                                            ...
                                            <li><a href="#">${c.product.productName}<span class="middle">x ${c.quantity}</span> <span class="last">${c.product.priceFormat}</span></a></li>                                       
                                            </c:forEach>
                                    </ul>
                                    <ul class="list list_2">

                                        <li><a href="#">Total <span>${cart.totalMoneyFormat}</span></a></li>
                                    ...
                                    <button class="primary-btn" type="submit">roceed to Paypal</button>
                                </div>
                            </div>
                        </div>
                    </form>
